...
//Le constructeur de copie par defaut alloue une nouvelle zone memoire pour l'objet s2
//par contre il fais pointer les atributs de la copie s2 vers les mêmes de l'original$
//C'est pourquoi on a la même adresse pour _tab de s1 et tab de s2 
//
