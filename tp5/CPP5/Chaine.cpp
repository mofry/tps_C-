...
//Fonctions de base Vecteur
Vecteur::Vecteur() : _capacity(10),_size(0),_tab(nullptr) {}
Vecteur::Vecteur(int capacity) : _tab(nullptr),_capacity(capacity),_size(0) {}
Vecteur::~Vecteur(){}

int Vecteur::capacity() const {return _capacity;}
int Vecteur::size() const {return _size;}
